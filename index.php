...
<body class="flex">
    <header>
        <div class="top-header flex justify-between align-center">
            ...
            <div class="top-left-header flex align-center">
                <div class="dots">
                    <i class="fas fa-th"></i>
                </div>
                <div class="avatar-wrap flex justify-center align-center">
                    <span>E</span>
                </div>
            </div>
        </div>
